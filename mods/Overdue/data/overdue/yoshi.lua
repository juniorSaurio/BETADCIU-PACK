...
function onCreate()
	...
	makeLuaSprite('PipeY','backgrounds/act2/act2_pipes_waryosh',-400,500)
	addLuaSprite('PipeY',true)
	setProperty('PipeY.visible',false)

	makeAnimatedLuaSprite(name_of_character, 'characters/yoshi', -50, 1000);
